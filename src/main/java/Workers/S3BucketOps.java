...
//        listBucketsResponse.buckets().forEach(x -> System.out.println(x.name()));
    ...
    public void uploadFile(File file, S3Client s3, String bucket, String key) {
    ...
    public void createBucketV2(S3Client s3, String bucketName) {
        s3.createBucket(CreateBucketRequest
                .builder()
                .bucket(bucketName)
                .createBucketConfiguration(
    ...
    public void uploadFileV2(String bucketName, String fileName) {
        ...
        S3Client s3 = S3Client
                ...
                .region(region)
                .build();*/
        Worker.s3.putObject(PutObjectRequest
                        .builder()
                        .bucket(bucketName)
                        .key(fileName)
                        .build(),
